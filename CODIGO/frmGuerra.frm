...
Begin VB.Form frmGuerra 
   ...
   ScaleHeight     =   3165
   ScaleWidth      =   4710
   Begin MSComctlLib.Slider sldOro 
      Height          =   195
      Left            =   1575
      TabIndex        =   3
      Top             =   1665
...
Private Sub Image1_Click()
    Call VaginaJugosa("/CREARGUERRA " & numeroSala & "," & sldUsers.Value & "," & sldOro.Value & "," & txtClan.Text)
    Unload Me
End Sub
...
lblPuntos.Caption = sldUsers.Value & "vs" & sldUsers.Value & " - " & PonerPuntos(sldOro.Value) & " monedas"
End Sub
