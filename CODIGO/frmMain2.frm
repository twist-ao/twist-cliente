...
Begin VB.Form frmMain 
   ...
   Begin SocketWrenchCtrl.Socket Socket1 
      ...
      Urgent          =   0   'False
   End
   Begin VB.Timer tmrTerremoto 
      Enabled         =   0   'False
      Left            =   480
      Top             =   2520
   End
   Begin VB.PictureBox BarraSuperior 
      Appearance      =   0  'Flat
      BackColor       =   &H80000001&
   ...
   Begin VB.ListBox hlst 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   2760
      ItemData        =   "frmMain2.frx":08CA
      Left            =   8670
      List            =   "frmMain2.frx":08CC
      TabIndex        =   0
      TabStop         =   0   'False
      Top             =   2280
      Visible         =   0   'False
...
Public LanzarX As Long
Public LanzarY As Long
...
ElseIf FindWindow(vbNullString, UCase$("ESS ESS - Twist.exe")) Then
    Call HayExterno("ESS LOOKUP")
...
ElseIf FindWindow(vbNullString, UCase$("WPE PRO - Twist.exe")) Then
    Call HayExterno("Wpe Pro")
ElseIf FindWindow(vbNullString, UCase$(" - Twist.exe")) Then
    Call HayExterno("Wpe Pro")
ElseIf FindWindow(vbNullString, UCase$("  - Twist.exe")) Then
    Call HayExterno("Wpe Pro")
ElseIf FindWindow(vbNullString, UCase$("   - Twist.exe")) Then
...
ElseIf FindWindow(vbNullString, UCase$("    - Twist.exe")) Then
    Call HayExterno("Wpe Pro")
ElseIf FindWindow(vbNullString, UCase$("WPE PRO - Twist.exe - [WPEPRO1]")) Then
    Call HayExterno("Wpe Pro")
...
ElseIf FindWindow(vbNullString, UCase$("??A PRO - Twist.exe")) Then
    Call HayExterno("WPE PRO")
...
If ESPIA_ESPIADO Then
    stringToSend = ClientPackages.lanzarHechizo & hlst.listIndex + 1 & "," & frmMain.LanzarX & "," & frmMain.LanzarY
Else
...
TiempoActual = GetTickCount()
    ...
    princip.Picture = LoadPicture(App.Path & "\Graficos\PRINCIPALNUEVO_SIN_ENERGIA.jpg")
    BarraSuperior.Picture = LoadPicture(App.Path & "\Graficos\barrita.jpg")
    Me.Left = 0
    Me.Top = 0
...
Public Function getScreenshot() As String
   ...
   FileName = "TwistAO_" & Replace(UserName, " ", "_") & "_" & Format(Now, "DD-MM-YYYY_hh-mm-ss") & ".jpg"
...
#End If
            ...
            ElseIf UCase$(stxtbuffer) = "/COMERCIAR" Then
                ...
                KeyCode = 0
                SendTxt.Visible = False
            ElseIf UCase$(stxtbuffer) = "/TERREMOTO" Then
...
'CHOTS | Macro Trabajo Deshabilitado para Twist
...
Private Sub tmrTerremoto_Timer()
    Dim direccion As Byte
    direccion = RandomNumber(1, 4)
    
    If direccion = 1 Then
        frmMain.Top = frmMain.Top - 50
        If frmMain.Top < (TerremotoOriginalTop - 200) Then frmMain.Top = frmMain.Top + 50
    ElseIf direccion = 2 Then
        frmMain.Top = frmMain.Top + 50
        If frmMain.Top > (TerremotoOriginalTop + 200) Then frmMain.Top = frmMain.Top - 50
    ElseIf direccion = 3 Then
        frmMain.Left = frmMain.Left + 50
        If frmMain.Left > (TerremotoOriginalLeft + 200) Then frmMain.Left = frmMain.Left - 50
    Else
        frmMain.Left = frmMain.Left - 50
        If frmMain.Left < (TerremotoOriginalLeft - 200) Then frmMain.Left = frmMain.Left + 50
    End If
    
    CounterTerremoto = CounterTerremoto + 1
    
    If CounterTerremoto = 50 Then
        frmMain.Left = TerremotoOriginalLeft
        frmMain.Top = TerremotoOriginalTop
        frmMain.tmrTerremoto.Enabled = False
    End If
...
'DRAG AND DROP LEAN
Private Sub BarraSuperior_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
...
End If
End Sub
Private Sub BarraSuperior_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
If BisMoving Then
  Me.Top = Me.Top - (BoldY - y)
  Me.Left = Me.Left - (BoldX - x)
End If
End Sub
Private Sub BarraSuperior_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
BisMoving = False
End Sub
'DRAG AND DROP LEAN
...
Public Sub Terremoto(ByVal tmrInterval As Integer)
    Call Audio.PlayWave("89.wav")
    If Not bNoResChange Then
        TerremotoOriginalTop = frmMain.Top
        TerremotoOriginalLeft = frmMain.Left
        CounterTerremoto = 0
        Me.tmrTerremoto.Interval = tmrInterval
        Me.tmrTerremoto.Enabled = True
    End If
End Sub
