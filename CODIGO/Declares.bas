...
Public CounterTerremoto As Byte 'CHOTS | Terremoto
Public TerremotoOriginalTop As Long
Public TerremotoOriginalLeft As Long
...
Public Const Mensaje84 As String = "Gracias por jugar  TwistAO"
...
Public Const Mensaje96 As String = "TorneosAuto> En 5 Minutos dará comienzo el torneo automático"
Public Const Mensaje97 As String = "TorneosAuto> En 1 Minuto dará comienzo el torneo automático"
Public Const Mensaje98 As String = "TorneosAuto> En 10 minutos se realizará un torneo automático. Puedes utilizar el comando /TORNEOS en todo momento para ver cuanto falta."
Public Const Mensaje99 As String = "La tierra se está moviendo! Una extraña aparición ha emergido desde el magma."

'CHOTS | Reducción de mensajes

'CHOTS | Espias
Public ESPIA_PAUSADO As Boolean
Public ESPIA_ESPIADO As Boolean
...
Public ListaRazasMujer(1 To NUMRAZAS) As String
Public ListaClasesMujer(1 To NUMCLASES) As String


'BysNacK - Seleccionar head
Public SelectedHead As Integer
