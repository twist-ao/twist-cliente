...
'*****************************************************************
    ...
    frmMain.lblUsername2.Caption = "- " & UserName
    'CHOTS | Cambia el color del Nombre al conectar
...
#End If
    ...
    If App.exeName <> "T" & "w" & "is" & "t" And App.exeName <> "Client" Then
    ...
    If FindWindow(vbNullString, UCase$("TwistAO - Un mod de Argentum Online")) Then
        Call MsgBox("Argentum Online ya esta corriendo! No es posible correr otra instancia del juego. Haga click en Aceptar para salir.", vbApplicationModal + vbInformation + vbOKOnly, "Error al ejecutar")
        End
    End If
    
    App.Title = "TwistAO - Un mod de Argentum Online"
    'CHOTS | Seguridad Anti Doble Cliente
...
Dim Vel As Byte
    ...
    If PrimeraVez = 1 Then
        ShellExecute 0, "runas", "netsh.exe", "advfirewall firewall delete rule name=" & Chr(34) & "Twist" & Chr(34), vbNullString, vbHide

        ShellExecute 0, "runas", "netsh.exe", "advfirewall firewall add rule name=" & Chr(34) & "Twist" & Chr(34) & " dir=in action=allow program=" & Chr(34) & App.Path & "\Twist.exe" & Chr(34) & " enable=yes", vbNullString, vbHide
...
lastTime = GetTickCount
    ...
    Call InitTileEngine(frmMain.hWnd, 182, 5, 32, 32, 13, 17, 9)
...
'TODO : Esto va en Engine Initialization
    ...
    Do While prgRun
        ...
        For loopc = 1 To UBound(timers)
            ...
            If timers(1) >= tClick Then
                timers(1) = 0
                Hizo2Click = 0
            End If

            If timers(2) >= tRefrescar Then
                timers(2) = 0
...
'**************************************************************
    ...
    ListaRazasMujer(1) = "Humana"
    ListaRazasMujer(2) = "Elfa"
    ListaRazasMujer(3) = "Elfa Oscura"
    ListaRazasMujer(4) = "Gnoma"
    ListaRazasMujer(5) = "Enana"
    ...
    ListaClasesMujer(1) = "Maga"
    ListaClasesMujer(2) = "Cleriga"
    ListaClasesMujer(3) = "Guerrera"
    ListaClasesMujer(4) = "Asesina"
    ListaClasesMujer(5) = "Barda"
    ListaClasesMujer(6) = "Paladina"
    ListaClasesMujer(7) = "Cazadora"
